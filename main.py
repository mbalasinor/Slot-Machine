    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if 1 <= lines <= MAX_LINES:
                ...
                print(f"Number must be between 1 and {MAX_LINES}.")
        else:
...
def get_bet():
    while True:
        ...
        if bet.isdigit():
            ...
            print(f"Bet must be a number between ${MIN_BET} and ${MAX_BET}.")
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enough funds to bet ${total_bet}. Your current balance is ${balance}.")
        else:
            break
